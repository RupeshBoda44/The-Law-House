...
public class FragCompletedCases extends Fragment implements View.OnClickListener {
    ...
    public static FragCompletedCases newInstance() {
...
//        mainActivity.ClickcableDispose();
        if (isVisible)
            setNews();
    ...
    private Map<String, String> paramNewsList() {
        return null;
    }
    ...
    private void setData() {
        ...
        mAdapter = new CompletedCaseAdapter(getActivity(),
    ...
    private void loadData(int page) {
        if (isInternetAvailable(getActivity())) {
            final ProgressHUD mProgressHUD = ProgressHUD.show(getActivity(), true, true, false, null);
            WebApiClient.getInstance().CompletedCases(paramMyBooking(String.valueOf(page))).enqueue(new Callback<CaseListModel>() {
                @Override
