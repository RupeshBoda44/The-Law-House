...
public class FragUnupdatedCases extends Fragment implements View.OnClickListener {
    ...
    private void loadData(int page) {
        ...
        if (isInternetAvailable(getActivity())) {
            ...
            WebApiClient.getInstance().UnUpdatedCases(paramMyBooking(String.valueOf(page))).enqueue(new Callback<CaseListModel>() {
                @Override
