...
public class FragServices extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new ServicesPagerAdapter(getActivity().getSupportFragmentManager());
        adapter.addFragment(FragSegmentLawList.newInstance(), "Segments of law and Legal");
        adapter.addFragment(FragUsefullLinkList.newInstance(), "Useful Link");
        adapter.addFragment(FragAboutUs.newInstance(), "About Us");
