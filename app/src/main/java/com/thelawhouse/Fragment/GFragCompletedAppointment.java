...
public class GFragCompletedAppointment extends Fragment implements View.OnClickListener {
    ...
    public static GFragCompletedAppointment newInstance() {
    ...
    private void loadData(int page) {
        ...
        if (isInternetAvailable(getActivity())) {
            ...
            WebApiClient.getInstance().CommpletedClientAppointMentList(paramMyBooking(String.valueOf(page))).enqueue(new Callback<CompletedAppointmentListModel>() {
                @Override
