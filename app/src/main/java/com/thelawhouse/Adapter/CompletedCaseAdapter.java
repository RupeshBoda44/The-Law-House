...
public class CompletedCaseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CompletedCaseAdapter(Context context, RecyclerViewClickListener mClickListeneR, RecyclerViewClickListener2 mClickListeneR2) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CompletedCaseAdapter.ItemViewHolder(mBinding.getRoot(), mBinding);
    }
